...
public class DesktopApplication1View extends FrameView {
    ...
    public DesktopApplication1View(SingleFrameApplication app) {
        ...
        //jPanel1.add(text);
        FileDrop fileDrop = new FileDrop(jPanel1, new FileDrop.Listener() {

            public void filesDropped(java.io.File[] files) {
                for (int i = 0; i < files.length; i++) {
                    try {
                        jTextArea1.append(files[i].getCanonicalPath() + "\n");
                        if (doelDir.getText().isEmpty()) {
                            doelDir.setText(files[i].getParent());
                        }
                    } // end try
    ...
    private void initComponents() {
        ...
        voorvoegsel = new javax.swing.JTextField();
        doelDir = new javax.swing.JTextField();
        ...
        voorvoegsel.setText(resourceMap.getString("voorvoegsel.text")); // NOI18N
        voorvoegsel.setName("voorvoegsel"); // NOI18N

        doelDir.setText(resourceMap.getString("doelDir.text")); // NOI18N
        doelDir.setName("doelDir"); // NOI18N
        doelDir.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                doelDirActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(mainPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(mainPanelLayout.createSequentialGroup()
                                        .addComponent(voorvoegsel, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(doelDir, javax.swing.GroupLayout.DEFAULT_SIZE, 492, Short.MAX_VALUE)))))))
                .addContainerGap())
        );
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(voorvoegsel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(doelDir, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//                System.out.println(line);
        ...
        gdGroup gdg = new gdGroup();
        int nrFiles = 0;

        nrFiles = gdg.groupFiles(doelDir.getText(), voorvoegsel.getText(), fileList);
    ...
    private void doelDirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doelDirActionPerformed
//        String txtdoeldir;
//        
//        
//        txtdoeldir = doelDir.getText();
...
//        }
    ...
    }//GEN-LAST:event_doelDirActionPerformed
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField doelDir;
    ...
    private javax.swing.JTextField voorvoegsel;
